"""Unit tests for the scan panels sidecar's read-proxy router (task 1.2).

Exercises `read_proxy.router` mounted on a LOCAL FastAPI app (never the
package-level `osprey.services.scan_panels.app.app`, which does not include
...
from osprey.services.scan_panels import read_proxy
