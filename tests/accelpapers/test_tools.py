"""Tests for all 6 AccelPapers MCP tools."""
...
class TestPapersSearch:
    ...
    @pytest.mark.asyncio
    async def test_search_with_conference_filter(self, patch_db):
        fn = get_tool_fn(papers_search)
    ...
    @pytest.mark.asyncio
    async def test_search_with_year_filter(self, patch_db):
        fn = get_tool_fn(papers_search)
    ...
    @pytest.mark.asyncio
    async def test_search_max_results(self, patch_db):
        fn = get_tool_fn(papers_search)
...
class TestPapersGet:
    @pytest.mark.asyncio
    async def test_get_existing_paper(self, patch_db):
    ...
    @pytest.mark.asyncio
    async def test_get_with_full_text(self, patch_db):
        fn = get_tool_fn(papers_get)
    ...
    @pytest.mark.asyncio
    async def test_get_without_full_text(self, patch_db):
        fn = get_tool_fn(papers_get)
    ...
    @pytest.mark.asyncio
    async def test_get_empty_texkey(self, patch_db):
        fn = get_tool_fn(papers_get)
    ...
    @pytest.mark.asyncio
    async def test_get_with_content(self, patch_db, sample_json_dir):
...
class TestPapersBrowse:
    @pytest.mark.asyncio
    async def test_browse_by_conference(self, patch_db):
    ...
    @pytest.mark.asyncio
    async def test_browse_by_year(self, patch_db):
        fn = get_tool_fn(papers_browse)
    ...
    @pytest.mark.asyncio
    async def test_browse_by_year_range(self, patch_db):
        fn = get_tool_fn(papers_browse)
    ...
    @pytest.mark.asyncio
    async def test_browse_sort_by_citation(self, patch_db):
        fn = get_tool_fn(papers_browse)
        result = json.loads(
...
class TestPapersListConferences:
    @pytest.mark.asyncio
    async def test_list_all_conferences(self, patch_db):
    ...
    @pytest.mark.asyncio
    async def test_list_with_pattern(self, patch_db):
        fn = get_tool_fn(papers_list_conferences)
    ...
    @pytest.mark.asyncio
    async def test_list_no_match(self, patch_db):
        fn = get_tool_fn(papers_list_conferences)
...
class TestPapersSearchAuthor:
    @pytest.mark.asyncio
    async def test_search_author(self, patch_db):
    ...
    @pytest.mark.asyncio
    async def test_search_author_with_year_filter(self, patch_db):
        fn = get_tool_fn(papers_search_author)
    ...
    @pytest.mark.asyncio
    async def test_search_author_empty(self, patch_db):
        fn = get_tool_fn(papers_search_author)
    ...
    @pytest.mark.asyncio
    async def test_search_author_sorted_by_citations(self, patch_db):
        fn = get_tool_fn(papers_search_author)
        result = json.loads(await fn(author="Smith"))
...
class TestPapersStats:
    ...
    @pytest.mark.asyncio
    async def test_stats_document_types(self, patch_db):
        fn = get_tool_fn(papers_stats)
        result = json.loads(await fn())
        stats = result["statistics"]
