...
class TestConversationMessage:
    ...
    def test_message_from_dict(self):
        ...
        data = {"type": "user", "content": "Test message", "timestamp": "2024-01-01T12:00:00"}
...
class TestConversation:
    ...
    def test_conversation_to_dict(self):
        ...
        msg = ConversationMessage(type="user", content="Hello")
        conv = Conversation(thread_id="test_123", name="Test", messages=[msg])
        data = conv.to_dict()
    ...
    def test_conversation_from_dict(self):
        ...
        data = {
            "thread_id": "test_123",
            "name": "Test",
            "messages": [{"type": "user", "content": "Hi", "timestamp": "2024-01-01T12:00:00"}],
