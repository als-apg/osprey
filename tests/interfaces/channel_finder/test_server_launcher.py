...
class TestChannelFinderLauncher:
    ...
    def test_config_reader_defaults(self):
        ...
        from osprey.mcp_server.server_launcher import _channel_finder_config

        with patch(
            "osprey.mcp_server.server_launcher.load_osprey_config",
            return_value={},
        ):
    ...
    def test_auto_launch_false_when_no_section(self):
        ...
        from osprey.mcp_server.server_launcher import _channel_finder_auto_launch
