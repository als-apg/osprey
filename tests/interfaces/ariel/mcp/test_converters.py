...
class TestWrapInHtml:
    ...
    def test_produces_valid_html(self):
        from osprey.interfaces.ariel.mcp.converters import _wrap_in_html
...
class TestPassthrough:
    ...
    async def test_returns_source_unchanged(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import passthrough
...
class TestHtmlToPng:
    ...
    async def test_calls_convert_html_to_image(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import html_to_png
...
class TestMarkdownToPng:
    ...
    async def test_renders_markdown_to_png(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import markdown_to_png
...
class TestNotebookToPng:
    ...
    async def test_renders_notebook(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import notebook_to_png
...
class TestJsonToPng:
    ...
    async def test_pretty_prints_json(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import json_to_png
...
class TestTextToPng:
    ...
    async def test_wraps_in_pre(self, tmp_path):
        from osprey.interfaces.ariel.mcp.converters import text_to_png
...
class TestGetConverter:
    ...
    def test_known_mime_types(self):
        from osprey.interfaces.ariel.mcp.converters import (
            get_converter,
            html_to_png,
            json_to_png,
            markdown_to_png,
    ...
    def test_unknown_image_type_passthrough(self):
        from osprey.interfaces.ariel.mcp.converters import get_converter, passthrough
    ...
    def test_unknown_mime_type_falls_back_to_text(self):
        from osprey.interfaces.ariel.mcp.converters import get_converter, text_to_png
