...
Lazy resolution
----------------
``CORE_CATEGORIES`` is a lazy mapping: iterating it yields the sixteen canonical
...
# this package. Static so the sixteen valid names are known without importing any
...
# The sixteen canonical core category names, without importing any sibling module.
