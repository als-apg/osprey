...
class RuntimeOverrideManager:
    ...
    def create_agent_control_defaults(self) -> dict[str, Any]:
        ...
        return {
            ...
            "task_extraction_bypass_enabled": self.get_override(
                "task_extraction_bypass_enabled", False
            ),
            "capability_selection_bypass_enabled": self.get_override(
            ...
            "python_execution_approval_enabled": self.get_override(
                "python_execution_approval_enabled", True
            ),
            "python_execution_approval_mode": self.get_override(
            ...
            "max_concurrent_classifications": self.get_override(
            ...
            "enable_probabilistic_expiration": self.get_override(
                "enable_probabilistic_expiration", True
            ),
            "enable_event_driven_invalidation": self.get_override(
                "enable_event_driven_invalidation", True
            ),
            "enable_semantic_analysis": self.get_override("enable_semantic_analysis", True),
            "semantic_similarity_threshold": self.get_override(
