...
def superperiod(sup: str) -> list:
    ...
    return [
        b.next(), Drift("L1end", 0.11960922),
        _sext(sup, "SHF", 1, _SHF),
        Drift("L2a", 0.35548000), Drift("L2b", 0.08902000),
        _quad(sup, "QF", 1, _QF),
        Drift("L3", 0.11400000),
        _sext(sup, "SHD", 1, _SHD),
        Drift("L4a", 0.11750000 / 2), b.next(), Drift("L4a", 0.11750000 / 2),
        _quad(sup, "QD", 1, _QD),
        Drift("L5a", 0.14298200), Drift("L5b", 0.10571600),
        _bend(sup, 1),
        Drift("L6", 0.21569930 + 15e-3),
        _sext(sup, "SD", 1, _SD),
        Drift("L7", 0.118784 + 0.105716 - 15e-3),
        _quad(sup, "QFA", 1, _QFA),
        Drift("L8a", 0.12450000 / 2), b.next(), Drift("L8a", 0.12450000 / 2),
        _sext(sup, "SF", 1, _SF),
        Drift("L9a", 0.31184400), Drift("L9b", 0.17885410),
        _bend(sup, 2),
        Drift("L9b", 0.17885410), Drift("L9a", 0.31184400),
        _sext(sup, "SF", 2, _SF),
        Drift("L8a", 0.12450000 / 2), b.next(), Drift("L8a", 0.12450000 / 2),
        ...
        Drift("L6", 0.21569930 + 15e-3),
        _bend(sup, 3),
        Drift("L5b", 0.10571600), Drift("L5a", 0.14298200),
        _quad(sup, "QD", 2, _QD),
        Drift("L4a", 0.11750000 / 2), b.next(), Drift("L4a", 0.11750000 / 2),
        _sext(sup, "SHD", 2, _SHD),
        Drift("L3", 0.11400000),
        _quad(sup, "QF", 2, _QF),
        Drift("L2b", 0.08902000), b.next(), Drift("L2a", 0.35548000),
